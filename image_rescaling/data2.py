...
def Div2KDataLoaders(batch_size, img_size=64, shuffle_training_data=True, full_size_test_imgs=False):
    ...
    dataset = SingleClassImageFolder("/rds/user/mgm52/hpc-work/invertible-image-rescaling/data/DIV2K/DIV2K_train_HR", transform=transform)
    ...
    if full_size_test_imgs:
        ...
        dataset = SingleClassImageFolder("/rds/user/mgm52/hpc-work/invertible-image-rescaling/data/DIV2K/DIV2K_valid_HR", transform=transform)
