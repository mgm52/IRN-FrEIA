...
def Div2KDataLoaders(batch_size, img_size=64, shuffle_training_data=True):
    ...
    dataset = datasets.ImageFolder("./data/DIV2K/DIV2K_train_LR_x2", transform=transform)
    ...
    transform = transforms.Compose([transforms.CenterCrop(img_size), transforms.ToTensor()])
    dataset = datasets.ImageFolder("./data/DIV2K/DIV2K_valid_LR_x2", transform=transform)
